        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              Votre <span className="text-gradient bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">Carrière</span>
            </h1>
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed mb-10 max-w-3xl mx-auto">
              Rejoignez une équipe passionnée de professionnels de la santé dans un environnement 
              stimulant et innovant. Développez vos compétences au service de la santé publique.
            </p>
